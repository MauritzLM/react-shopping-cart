    ...
    <div className="App">
      ...
      <main>
        <Routes>
          ...
          <Route path='/react-shopping-cart/shopping-cart' element={<ShoppingCart cart={cart} handleCartRemove={handleCartRemove} handleConfirmedPayment={handleConfirmedPayment} />} />
          <Route path="/react-shopping-cart/products">
